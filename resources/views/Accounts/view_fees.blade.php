              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone">Late Charges</th>
                    <th class="hidden-phone">Fee Type</th>
                ...
                <tbody>
                    ...
                    <tr class="gradeX">
                        ...
                        <td class="center hidden-phone">{{$fee->late_charges}}</td>
                        <td class="center hidden-phone">{{$fee->fee_type}}</td>
                        <td class="center hidden-phone">{{$fee->amount}}</td>
                        <td>
                        <button type="submit" class="btn btn-success btn-xs viewBtn" data-toggle="modal" data-target="#myModal" id="{{$fee->fee_id}}"><i class="fa fa-eye"></i></button>
                          <a href="fees/{{$fee->fee_id}}/edit"><button class="btn btn-primary btn-xs"><i class=" fa fa-pencil"></i></button></a>
                          <a href="fees/delete/{{$fee->fee_id}}"><button class="btn btn-danger btn-xs"><i class=" fa fa-trash-o"></i></button></a>
                        </td>
                    </tr>
        ...
        <div class="container">
            ...
            <div class="modal fade" id="myModal" role="dialog">
             ...
             <form class="form-horizontal style-form" >
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="class_id" id="class_id">
                        ...
                        @endphp
                            ...
                            <option value="{{$classes->class_id}}">{{$classes->class_id}}</option>
                            @endforeach
                      </select>
                  </div>
                </div>
                ...
                {{-- <button type="button" class="btn btn-theme editBtn">Update</button> --}}
            </div>
            </div>
                </div>
