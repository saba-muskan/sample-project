              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" >
                <thead>
                  <tr>
                    ...
                    <th>Medical_Allownace</th>
                    <th>Transport_Allownace</th>
                    <th>Cp_Fund</th>
                    <th>Income_Tax</th>
                    <th>Total Amount</th>
                ...
                <tbody>
                    ...
                    <tr class="gradeX">
                        ...
                        <td>{{$sal->year}}</td>
                          <td>{{$sal->basic_pay}}</td>
                          <td>{{$sal->House_Allowance}}</td>
                          <td>{{$sal->Medical_Allownace}}</td>
                          <td>{{$sal->Transport_Allownace}}</td>
                          <td>{{$sal->Cp_Fund}}</td>
                          <td>{{$sal->Income_Tax}}</td>
                          <td>{{$sal->Net_Pay}}</td>
                    
                       {{-- --}}
                       {{-- <td><button type="submit" class="btn btn-success btn-xs viewBtn" data-toggle="modal" data-target="#myModal" id="{{$sal->employee_id}}"><i class=" fa fa-eye"></i></button> --}}
                          {{-- <a href="employeeSal/{{$sal->employee_id}}/edit"><button class="btn btn-primary btn-xs"><i class=" fa fa-pencil"></i></button></a> --}}
