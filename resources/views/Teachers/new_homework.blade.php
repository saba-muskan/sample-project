        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="POST" action="/homework" accept-charset="UTF-8" enctype="multipart/form-data">
                @csrf
...
@endforeach
        ...
        <div class="form-group">
           <label class="col-sm-2 col-sm-2 control-label">Upload Assignment</label>
           <div class="col-sm-10">
           <input type="file" name="file_path" class="form-control" accept=".xlsx,.xls,image/*,.doc, .docx,.ppt, .pptx,.txt,.pdf" required>
            </div>
        </div>
        <div class="form-group">
           <label class="col-sm-2 col-sm-2 control-label">Assignment Title</label>
           <div class="col-sm-10">
           <input type="text" name="homework" class="form-control" required>
            </div>
        </div>
        <div class="form-group">
