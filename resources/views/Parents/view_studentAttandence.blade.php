...
@include('layouts.header')
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Student Attandence</h3>
        <div class="row mb">
          <!-- page start-->
          <div class="content-panel">
            <div class="adv-table" align="right">
                <form class="example" action="/searchattandance_view">
                    <label>Search:</label>
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" >
                ...
                <tbody>
                    ...
                    @foreach ($student_attandence as $stu)
