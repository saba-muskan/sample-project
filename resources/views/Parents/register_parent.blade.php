        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="POST" action="/parents" accept-charset="UTF-8" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <input id="father_email" type="email" class="form-control @error('father_email') is-invalid @enderror" name="father_email" value="{{ old('father_email') }}" required autocomplete="email" required>
                      @error('email')
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="father_phone_number" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="father_annual_income" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <input id="mother_email" type="email" class="form-control @error('email') is-invalid @enderror" name="mother_email" value="{{ old('email') }}" required autocomplete="email" required>
                      @error('email')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="mother_phone_number" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="mother_cnic" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="mother_annual_income" required>
                  </div>
                </div>
                <div class="form-group">
