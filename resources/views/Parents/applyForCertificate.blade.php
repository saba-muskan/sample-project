        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
                ...
                <form class="form-horizontal style-form" method="POST" action="/applyforcert" accept-charset="UTF-8" enctype="multipart/form-data">
                    @csrf
                    @php
                  $cl = App\Parents::all();
               @endphp
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                   <select name="parent_id" class="form-control" required>
                       <option></option>
                       @foreach ($cl as $c)
                       <option value="{{$c->parent_id}}">{{$c->father_name}}</option>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Application Date</label>
                    <div class="col-sm-10">
