              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" >
                ...
                <tbody>
                    ...
                    <tr class="gradeX">
                       ...
                       <td>
                           <button type="submit" class="btn btn-success btn-xs viewBtn" data-toggle="modal" data-target="#myModal" id="{{$d->job_id}}"><i class=" fa fa-eye"></i></button>
                          <a href="jobs/{{$d->job_id}}/edit"><button class="btn btn-primary btn-xs"><i class=" fa fa-pencil"></i></button></a>
                          <a href="delete/{{$d->job_id}}"><button class="btn btn-danger btn-xs"><i class=" fa fa-trash-o"></i></button></a>
                          {{-- <button class="btn btn-danger btn-xs" id="delete/{{$d->job_id}}"><i class=" fa fa-trash-o"></i></button> --}}
                        </td>
                    </tr>
