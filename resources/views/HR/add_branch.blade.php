        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
                ...
                <form class="form-horizontal style-form" method="POST" action="/addbranch" accept-charset="UTF-8" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="tel-no" required>
                      </div>
                  </div>
                  @php
                  $cl = App\Area::all();
