                    ...
                    <td>
                            ...
                            <div class="form-check">
                              <label class="form-check-label" for="radio1">
                                <input disabled   {{$d->status == 'present' ? 'checked' : '' }} type="radio" class="radio_btn form-check-input"  value="present" >Present
                              </label>
                            </div>
                            <div class="form-check">
                              <label class="form-check-label" for="radio2">
                                <input   disabled {{$d->status == 'absent' ? 'checked' : '' }} type="radio" class="radio_btn form-check-input"  value="absent">Absent
                              </label>
                            </div>
                    </td> 
