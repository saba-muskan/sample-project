                ...
                <tbody>
                    ...
                    <tr class="gradeX">
                        ...
                        <td>{{$branch->address}}</td>
                          <td>{{$branch->area_id}}</td>
                       
                       <td><button type="submit" class="btn btn-success btn-xs viewBtn" data-toggle="modal" data-target="#myModal" id="{{$branch->branch_id}}"><i class=" fa fa-eye"></i></button>
                          <a href="branch/{{$branch->branch_id}}/edit"><button class="btn btn-primary btn-xs"><i class=" fa fa-pencil"></i></button></a>
