        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Tranfer </h4>
             ...
             @endphp
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="trasfer_Reqdate" required>
                  </div>
                </div>
                <div class="form-group">
               ...
               @endphp
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="From_Campus" required>
                      <option value=""></option>
               ...
               @endphp
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="To_Campus" required>
                      <option value=""></option>
                      @foreach ($branch as $item)
                      <option value="{{$item->branch_id}}">{{$item->branch_name	}}</option>
                      @endforeach
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="trasfer_date" required>
                  </div>
                </div>
