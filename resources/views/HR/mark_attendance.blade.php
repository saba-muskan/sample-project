          ...
          <div class="col-lg-12">
            <div style="overflow:scroll;" class="site-wrap">
              {{-- <table style="margin-bottom:5%;" class="animated slideInUp" id="customers">
                ...
                <table class="animated slideInUp table " id="customers">
                  <tr>
                     <th>Employee Name</th>
                     <th>Employee Id</th>
                     <th>Action</th>
                  ...
                  <form method='post' action="/save_attendance" accept-charset="UTF-8" class="myForm">
                  {{csrf_field()}}  
                  @foreach($employee as $emp)
                    <fieldset id="group_Murtuza Mehdi">
                      <tr>
                        <td>
                          <label class="name" name="name[{{$a}}]">{{$emp->employee_name}}</label>
                          <input type="hidden" value="{{$emp->employee_id}}" name="employee_id[{{$a}}]">
