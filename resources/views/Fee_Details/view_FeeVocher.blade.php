              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                    ...
                    <tr class="gradeX">
                        ...
                        <td>{{$fee->due_date}}</td>
                        <td>{{$fee->fee_month}}</td>
                        <td>{{$fee->current_ammount}}</td>
                        <td>{{$fee->arrears}}</td>
                        @if ($fee->fee_status==1)
                            <td><span class="label label-success label-mini">Paid</span></td>
                            @else
                            <td><span class="label label-danger label-mini">Unpaid</span><a href="fee/{{$fee->student_id}}/{{$fee->due_date}}/edit"><button class="btn btn-primary btn-xs"><i class=" fa fa-pencil"></i></button></a></td>
                            @endif
                        <td>
                        {{-- <button type="submit" class="btn btn-success btn-xs viewBtn" data-toggle="modal" data-target="#myModal" id="{{$student->student_id}}"><i class=" fa fa-eye"></i></button> --}}
                            ...
                            <a href="/voucher/{{$fee->student_id}}/{{$fee->fees_id}}" ></i>Download</button>
                        </td>
                    </tr>
